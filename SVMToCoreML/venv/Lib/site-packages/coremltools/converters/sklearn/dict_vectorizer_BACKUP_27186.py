...
from ... import SPECIFICATION_VERSION, INTERNAL_SPECIFICATION_VERSION 
from ...models._interface_management import set_transform_interface_params
=======
from ...__init__ import SPECIFICATION_VERSION
...
from ...models import create_feature_vectorizer
...
def convert(model, input_features, output_features):
    ...
    assert isinstance(input_features[0][1], datatypes.Dictionary)
